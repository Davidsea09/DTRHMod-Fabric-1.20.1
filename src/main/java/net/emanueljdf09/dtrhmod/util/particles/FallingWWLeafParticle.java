...
public class FallingWWLeafParticle extends SpriteBillboardParticle {
    private float rotationSpeed;
    private final float sample;
    private final float rotSpeedMultiplier;

    protected FallingWWLeafParticle(ClientWorld world, double x, double y, double z,
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world,
                                       ...
                                       double velocityX, double velocityY, double velocityZ) {
            return new FallingWWLeafParticle(world, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
        }
    }
}
